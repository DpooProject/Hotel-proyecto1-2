 ...
 * @author user
 */
public class AdminCargarHabitaciones extends javax.swing.JFrame {

    /**
     * Creates new form AdminCrearHabitacion
     */
    public AdminCargarHabitaciones() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        Titulo.setText("2.  Cargar nuevas habitaciones con archivo csv ");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdminCargarHabitaciones().setVisible(true);
            }
        });
    }
