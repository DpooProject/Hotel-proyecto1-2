 ...
 * @author user
 */
public class EmployerInterfaz extends javax.swing.JFrame {

	/**
	 * Creates new form AdminInterfaz
	 */
	public EmployerInterfaz() {
		initComponents();
	}
	...
	private void initComponents() {
		...
		PanelAzulLayout
				.setHorizontalGroup(PanelAzulLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(PanelAzulLayout.createSequentialGroup().addGap(45, 45, 45)
								.addGroup(PanelAzulLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
										.addComponent(titulo2).addComponent(titulo1))
		...
		Background.add(BotonSiguiente, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 350, -1, -1));
	...
	private void BotonSiguienteActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_BotonSiguienteActionPerformed
		// TODO add your handling code here:
		String elementoSeleccionado = (String) ComboBoxAcciones.getSelectedItem();
		if (elementoSeleccionado == "1. Registrar  consumo") {
			dispose();
			try {
			...
			java.awt.EventQueue.invokeLater(new Runnable() {
				public void run() {
					new GeneralRegistrarConsumo().setVisible(true);
				}
			});
		} else if (elementoSeleccionado == "2. Registrar pagos ( unicamente si se paga de contado)​") {
			dispose();
			try {
				for (javax.swing.UIManager.LookAndFeelInfo info : javax.swing.UIManager.getInstalledLookAndFeels()) {
					if ("Nimbus".equals(info.getName())) {
				...
				java.util.logging.Logger.getLogger(GeneralRegistrarPago.class.getName())
						.log(java.util.logging.Level.SEVERE, null, ex);
			} catch (InstantiationException ex) {
				java.util.logging.Logger.getLogger(GeneralRegistrarPago.class.getName())
						.log(java.util.logging.Level.SEVERE, null, ex);
